...
export type DmcaActingAs =
  | 'AUTHORIZED_AGENT'
  | 'OWNER';

export type DmcaFormInput = {
  accuracyStatement: Scalars['Boolean']['input'];
  actingAs: DmcaActingAs;
  complainantAddress: Scalars['String']['input'];
  complainantEmail: Scalars['String']['input'];
  complainantName: Scalars['String']['input'];
  complainantOrg?: InputMaybe<Scalars['String']['input']>;
  complainantPhone: Scalars['String']['input'];
  copyrightedWork: Scalars['String']['input'];
  goodFaithStatement: Scalars['Boolean']['input'];
  infringingUrls: Array<Scalars['String']['input']>;
...
export type HelpStationAdminContextWorkspaceInfo = {
  ...
  plan: Plan;
  /** All restrictions ever applied to this workspace (ACTIVE, LIFTED, and SUPERSEDED), newest first. */
  restrictions: Array<HelpStationRestrictionInfo>;
  slackChannelId?: Maybe<Scalars['String']['output']>;
...
export type HelpStationRestrictionAppealInfo = {
  __typename?: 'HelpStationRestrictionAppealInfo';
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['String']['output'];
  message: Scalars['String']['output'];
  resolutionNote?: Maybe<Scalars['String']['output']>;
  resolvedAt?: Maybe<Scalars['DateTime']['output']>;
  resolvedBy?: Maybe<HelpStationAdminContextWorkspaceMemberUserInfo>;
  reviewStartedAt?: Maybe<Scalars['DateTime']['output']>;
  status: WorkspaceRestrictionAppealStatus;
  submittedBy?: Maybe<HelpStationAdminContextWorkspaceMemberUserInfo>;
  threadId?: Maybe<Scalars['String']['output']>;
  type: WorkspaceRestrictionAppealType;
};

export type HelpStationRestrictionInfo = {
  __typename?: 'HelpStationRestrictionInfo';
  actor?: Maybe<HelpStationAdminContextWorkspaceMemberUserInfo>;
  /** All appeals on this restriction, newest first. Unlike the dashboard-facing type, USER appeals are not filtered out. */
  appeals: Array<HelpStationRestrictionAppealInfo>;
  createdAt: Scalars['DateTime']['output'];
  deploysStopped: Scalars['Boolean']['output'];
  id: Scalars['String']['output'];
  liftedBy?: Maybe<HelpStationAdminContextWorkspaceMemberUserInfo>;
  /** Set when this restriction is a cascade child; the origin ban that caused it. */
  originatingRestriction?: Maybe<HelpStationRestrictionOriginInfo>;
  reason: Scalars['String']['output'];
...
/** Slim view of the origin ban a cascaded restriction stems from. */
export type HelpStationRestrictionOriginInfo = {
  __typename?: 'HelpStationRestrictionOriginInfo';
  createdAt: Scalars['DateTime']['output'];
  id: Scalars['String']['output'];
  reason: Scalars['String']['output'];
  status: RestrictionStatus;
  type: RestrictionType;
  workspace: HelpStationRestrictionWorkspaceInfo;
};

export type HelpStationRestrictionWorkspaceInfo = {
  __typename?: 'HelpStationRestrictionWorkspaceInfo';
  id: Scalars['String']['output'];
  name?: Maybe<Scalars['String']['output']>;
};
...
export type HelpStationServiceInstanceLimitOverrideScopedOp =
  | 'set'
  | 'unset';

export type HelpStationServiceInstanceLimitOverrideScopedResult = {
  __typename?: 'HelpStationServiceInstanceLimitOverrideScopedResult';
...
export type HelpStationServiceInstanceLimitOverrideUpsertScopedInput = {
  environmentId: Scalars['String']['input'];
  op: HelpStationServiceInstanceLimitOverrideScopedOp;
  /** Dotted path into the admin block. One of: containers.cpu, containers.memoryBytes, containers.pidLimit, containers.minReplicaCpu, containers.minReplicaMemoryBytes, deploys.replicas */
  path: Scalars['String']['input'];
  serviceId: Scalars['String']['input'];
  value?: InputMaybe<Scalars['Float']['input']>;
};

export type HelpStationServiceInstanceLimitsView = {
  __typename?: 'HelpStationServiceInstanceLimitsView';
  adminConfig?: Maybe<Scalars['JSON']['output']>;
  environmentId: Scalars['String']['output'];
  planLimit: Scalars['SubscriptionPlanLimit']['output'];
  serviceId: Scalars['String']['output'];
  serviceName: Scalars['String']['output'];
  userConfig?: Maybe<Scalars['JSON']['output']>;
  workspaceId?: Maybe<Scalars['String']['output']>;
  workspaceName?: Maybe<Scalars['String']['output']>;
...
export type HelpStationUserRestrictionEntry = {
  __typename?: 'HelpStationUserRestrictionEntry';
  /** The user's current role in the restricted workspace; null when they are no longer a member. */
  membershipRole?: Maybe<TeamRole>;
  restriction: HelpStationRestrictionInfo;
...
export type Mutation = {
  ...
  /** Drop waiting UI/metrics ClickHouse limiter jobs and reset stale UI limiter running state. Does not touch temporal/billing queue. */
  drainClickhouseBackpressureMetricsQueue: Scalars['Boolean']['output'];
  ...
  /** Takes down the most recent deployment serving a domain. Throws if no deployment is currently serving the domain. Returns the removed deployment id. */
  helpStationRemoveLatestDeploymentForDomain: Scalars['String']['output'];
  ...
  /** Set or unset a single scoped path in a service instance's admin limit override. Merges into the existing admin config — other paths are preserved. If the admin config becomes empty after an unset, it is cleared. CPU and memory changes propagate to running deployments. */
  helpStationServiceInstanceLimitOverrideUpsertScoped: HelpStationServiceInstanceLimitOverrideScopedResult;
  ...
  /** Set the queue highWater for temporal/billing ClickHouse queries. */
  setClickhouseBackpressureBillingHighWater: Scalars['Boolean']['output'];
  ...
  /** Set queue strategy for temporal/billing ClickHouse queries. */
  setClickhouseBackpressureBillingStrategy: Scalars['Boolean']['output'];
  ...
  /** Set the queue highWater for UI/metrics ClickHouse queries. */
  setClickhouseBackpressureMetricsHighWater: Scalars['Boolean']['output'];
  ...
  /** Set queue strategy for UI/metrics ClickHouse queries. */
  setClickhouseBackpressureMetricsStrategy: Scalars['Boolean']['output'];
  ...
  /** Submit a public DMCA takedown notice. Verifies Cloudflare Turnstile and opens an abuse thread in Central Station. Returns true on success; throws on failed verification or validation. */
  submitDmcaClaim: Scalars['Boolean']['output'];
  /**
...
export type MutationHelpStationRemoveLatestDeploymentForDomainArgs = {
  domainName: Scalars['String']['input'];
  reason: Scalars['String']['input'];
  threadId?: InputMaybe<Scalars['String']['input']>;
};
...
export type MutationHelpStationServiceInstanceLimitOverrideUpsertScopedArgs = {
  input: HelpStationServiceInstanceLimitOverrideUpsertScopedInput;
};
...
export type MutationSetClickhouseBackpressureBillingHighWaterArgs = {
  highWater: Scalars['Int']['input'];
};
...
export type MutationSetClickhouseBackpressureBillingStrategyArgs = {
...
export type MutationSetClickhouseBackpressureMetricsHighWaterArgs = {
  highWater: Scalars['Int']['input'];
};
...
export type MutationSetClickhouseBackpressureMetricsStrategyArgs = {
  strategy: Scalars['String']['input'];
};
...
export type MutationSubmitDmcaClaimArgs = {
  input: DmcaFormInput;
};
...
export type PgBackrestSummary = {
  ...
  avgFullBackupIntervalMs?: Maybe<Scalars['Float']['output']>;
  ...
  walGapPct?: Maybe<Scalars['Float']['output']>;
  walGapSeconds?: Maybe<Scalars['Float']['output']>;
...
export type PitrFleetAggregates = {
  ...
  totalEgressGb?: Maybe<Scalars['Float']['output']>;
  totalServiceSpendDollars?: Maybe<Scalars['Float']['output']>;
  walGapFleetPct?: Maybe<Scalars['Float']['output']>;
  walGapTotalSeconds: Scalars['Float']['output'];
...
export type PostgresPitrService = {
  ...
  serviceEgressGb?: Maybe<Scalars['Float']['output']>;
...
export type Query = {
  ...
  /** Read a service instance's plan baseline, user-set limits, and admin override. Used by CS Chat's getServiceInstanceLimits tool to capture the baseline before suggesting `update_service_limit`. */
  helpStationServiceInstanceLimits: HelpStationServiceInstanceLimitsView;
  ...
  /** Current and historical workspace restrictions related to a user: restrictions on workspaces they are a member of, plus restrictions they appealed (covers users since removed from the workspace). Newest first. */
  helpStationUserRestrictions: Array<HelpStationUserRestrictionEntry>;
  ...
  /** Sandbox/VM usage for a single project's current billing period, as AggregatedUsage rows (CPU, memory, egress). */
  projectUsageVM: Array<AggregatedUsage>;
  ...
  /** Sandbox/VM usage for a workspace's current billing period, as AggregatedUsage rows (CPU, memory, egress). */
  workspaceUsageVM: Array<AggregatedUsage>;
...
export type QueryHelpStationServiceInstanceLimitsArgs = {
  environmentId: Scalars['String']['input'];
  serviceId: Scalars['String']['input'];
};
...
export type QueryHelpStationUserRestrictionsArgs = {
  first?: InputMaybe<Scalars['Int']['input']>;
  userId: Scalars['String']['input'];
};
...
export type QueryProjectUsageVmArgs = {
  projectId: Scalars['String']['input'];
};
...
export type QueryWorkspaceUsageVmArgs = {
  workspaceId: Scalars['String']['input'];
};
...
export type Subscription = {
  ...
  /** Subscribe to phase transitions of an HA PITR enable/disable workflow. Backfills the current persisted state on connect so a fresh page load sees what's in flight without waiting for the next transition. */
  pitrHaWorkflowProgress: PitrHaWorkflowProgress;
  /**
...
export type SubscriptionPitrHaWorkflowProgressArgs = {
  environmentId: Scalars['String']['input'];
  rootServiceId: Scalars['String']['input'];
};
